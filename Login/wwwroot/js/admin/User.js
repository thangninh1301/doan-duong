var Viewmodel = function () {
    ...
    self.loadDepartment = function (item1) {
        ...
        $.ajax({
           ...
           // url: "https://localhost:44310/api/Departments",
    ...
    self.click = function () {
        $.ajax({
            ...
            //url: "https://localhost:44310/api/Admin/Doctor",
            contentType: "application/json",
            success: function (data) {
                $.each(data, function (ex, item) {
                    item.nameDepartment = "";
                    $.ajax({
                       ...
                       // url: "https://localhost:44310/api/Departments/" + item.idDepartment,
                        contentType: "application/json",
       ...
       /* $('#idDepartment').val(item.idDepartment);*/
        ...
        self.save = function () {
            ...
            $.ajax({
                ...
                //url: "https://localhost:44310/api/User/" + item.id,
    ...
    self.del = function (item) {
        if (confirm("ban muon xoa " + item.id + " khong")) {
            $.ajax({
               ...
               // url: "https://localhost:44310/api/User/delete/" + item.id,
                success: function (data) {
                    self.click();
