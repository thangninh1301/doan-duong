var viewmodel = function () {
    ...
    self.click = function () {
        ...
        $.ajax({
            type: "GET",
            url: "https://backend-btl.mooo.com/api/UserApointmentTicket/"+id,
   ...
   /* self.click = function () {
    ...
    self.createRegister = function (item) {
       ...
       /* $('#idPatient').val("");*/
        ...
        self.save = function () {
            ...
            $.ajax({
                type: "POST",
                url: "https://backend-btl.mooo.com/api/UserRegisterTicket",
    ...
    self.userResult = function () {
        ...
        $.ajax({
            type: "GET",
            url: "https://backend-btl.mooo.com/api/UserResult",
            contentType: "application/json",
            success: function (data) {
                self.resultArrays([]);
                $.each(data, function (ex, item) {
